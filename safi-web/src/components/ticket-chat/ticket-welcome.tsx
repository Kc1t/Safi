...
export function TicketWelcome() {
    return (
        ...
        >
            ...
            >
                Informe seu nome, email e setor para que eu possa te ajudar da melhor forma possível.
                <br />
                Se precisar de ajuda com o SAFI ou Qualquer outro assunto, estou aqui para isso!
            </motion.p>
